...
static void open_crate(char const * const url)
{
...
static void close_crate(char const * const url)
{
...
static void unlock_drawer(char const * const url)
{
...
static void lock_drawer(char const * const url)
{
...
static void set_spare(char const * const url)
{
...
static void clear_spare(char const * const url)
{
...
static void get_reset_state(char const * const url)
{
